...
| <a href="https://github.com/jordantroberts/split_the_bill">Bill Splitter</a> | A web app which aims to reduce that part of the dining experience where everybody tries to work out how to split the bill. Users input the cost of the bill, the tip they would like to leave and the number of diners and the app will split the bill equally among them. | 1 afternoon | JavaScript, Jasmine, HTML, Heroku |
